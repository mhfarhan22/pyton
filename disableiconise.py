...
class MyWindow(Qmainwindow)
    def __init__(self):
        ...
        #self.setWindowFlag(Qtcore.Qt.FramelesWindowHint)
        set.setwindowflag(QtCore.Qt.FramelesswindowHint,False)
        set.setWindowFlag(Qtore.Qt.WindowCloseButtonHint,False)
